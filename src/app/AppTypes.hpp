...
enum MenuAndControlId {
    ...
    IDM_VARIANT_STANDARD = 9401,
    IDM_VARIANT_DIAGONAL = 9402,
    IDM_VARIANT_HYPER = 9403,
    IDM_VARIANT_DIAGONAL_HYPER = 9404,
    ...
    IDC_BTN_AUTOPLAY_BACK = 3050,
    IDC_BTN_AUTOPLAY_PLAY = 3051,
    IDC_BTN_AUTOPLAY_FWD  = 3052,
    IDC_BTN_AUTOPLAY_STOP = 3053,
    IDC_LABEL_AUTOPLAY_SPEED = 3054,
    IDC_SLIDER_AUTOPLAY_SPEED = 3055,
    IDC_LABEL_AUTOPLAY_VAL = 3056,
